...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 178.28
  #define DEFAULT_bedKi 34.28
  #define DEFAULT_bedKd 618.04
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 170, 170, 20, 120 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.5, -6.5, -1 }
...
#define X_BED_SIZE 231 // 4mm less because of X endstop
#define Y_BED_SIZE 231 // 4mm less because of y endstop

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0  // Physical X endstop = 4mm to the right on the bed. Cura negative nozzle x offset needed if making this positive 
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_HEIGHT      0.4        // (mm) Z height of nozzle at tramming points
